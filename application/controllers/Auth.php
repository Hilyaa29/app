...
class Auth extends CI_Controller {
	...
	private function _sendEmail($token, $type)
	{
		...
		$config['smtp_user'] = 'hilyabalqis123@gmail.com';
		$config['smtp_pass'] = 'mnplkcspcgyycfvw';
		...
		$this->email->from('hilyabalqis123@gmail.com', 'Web Programing SMKN8Jember');
